export default function TeamSection() {
  return (
    <>
      <section className=" bg-gray-800 py-8 font-sans">
        <div class="mx-auto max-w-screen-xl py-8 px-4 lg:py-16 lg:px-6 ">
          <div className="mx-auto mb-8 max-w-screen-sm text-center lg:mb-16">
            ...
            <p className="font-light text-white  dark:text-gray-400 sm:text-xl lg:mb-16">
              Explore the whole collection of open-source web components and
              elements built with the utility classes from Tailwind
            </p>
          </div>
          <div className="mb-6 grid gap-8 md:grid-cols-2 lg:mb-16">
            <div className="items-center rounded-lg bg-gray-300 shadow dark:border-gray-700 dark:bg-gray-800 sm:flex">
              <a href="*">
                <img
            ...
            <div className="items-center rounded-lg bg-gray-300 shadow dark:border-gray-700 dark:bg-gray-900 sm:flex">
              <a href="*">
                <img
                  className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg"
